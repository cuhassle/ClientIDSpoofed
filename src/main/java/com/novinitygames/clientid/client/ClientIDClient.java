...
public class ClientIDClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientPlayConnectionEvents.JOIN.register((handler, sender, client) -> {
            ...
            ModCheckC2SPayload payload = new ModCheckC2SPayload(client.player.getGameProfile().getId().toString());
        ...
        ClientPlayNetworking.registerGlobalReceiver(ChartsS2CPayload.ID.getId(), (client, handler, payload, sender) -> {
            pieChartDisabled = payload.readBoolean();
        });
    }
}
