...
public record VersionC2SPayload(String list) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, VersionC2SPayload> CODEC = PacketCodec.tuple(PacketCodecs.STRING, VersionC2SPayload::list, VersionC2SPayload::new);
