...
public record ChartsS2CPayload(String list) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, ChartsS2CPayload> CODEC = PacketCodec.tuple(PacketCodecs.BOOLEAN, ChartsS2CPayload::list, ChartsS2CPayload::new);
